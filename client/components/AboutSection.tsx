      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="lg:pl-12">
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-accent mb-6 inline-block">
              Our Heritage
            </span>
            ...
            <div className="space-y-6 mb-12">
              <p className="text-muted-foreground leading-relaxed text-lg">
                L'ÉLÉGANCE is not just a boutique; it's a smart fashion
                ecosystem. By integrating cutting-edge digital technology into
                our design and inventory processes, we ensure that every piece
                is both a statement of style and a masterpiece of precision.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                From AI-driven style recommendations to a seamless digital-first
                shopping experience, we are redefining what it means to be a
                premium clothier in the 21st century. Our story is one of
                tradition meeting technology, resulting in a wardrobe that is
