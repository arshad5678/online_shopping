    ...
    <footer className="bg-primary text-primary-foreground py-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand Info */}
          <div>
            <h3 className="text-2xl font-serif font-bold mb-6 tracking-tighter">
              L'ÉLÉGANCE
            </h3>
            <p className="text-sm text-primary-foreground/60 leading-relaxed mb-6">
              A modern, smart fashion boutique dedicated to bringing you the
              most elegant and technologically curated collections.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-primary-foreground/60 mb-6">
              Subscribe to get the latest trends and exclusive offers.
            </p>
